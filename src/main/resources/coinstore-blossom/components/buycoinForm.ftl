...
[#import "coinstore_macro.ftl" as cmacro /]
...
<form action="?" method="POST">
   ...
   <tr>
    ...
    [@cmacro.formSingleSelectLongId path="orderForm.fundingsourceId" options=fundingSourcesHash  /]
     &nbsp;[@spring.showErrors separator=", " classOrStyle="errorMessage" /]</td>
    </tr>
  
    <tr>
    <td>wallet</td><td>
    [@cmacro.formSingleSelectLongId path="orderForm.walletId" options=walletsHash  /]
     &nbsp;[@spring.showErrors separator=", " classOrStyle="errorMessage" /]</td>
    </tr>
