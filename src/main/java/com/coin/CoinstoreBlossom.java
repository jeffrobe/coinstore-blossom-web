...
/**
 * This class manages the lifecycle of the coinstore-blossom module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class CoinstoreBlossom extends BlossomModuleSupport implements ModuleLifecycle {
